...
\include{configuracao/pacotes}
\include{configuracao/comandos}
...
\include{pre-textuais/folharosto}
...
\input{pre-textuais/nomenclatura}
\newpage

\pretextualchapter{Lista de Abreviações}
\input{pre-textuais/abreviacoes}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
